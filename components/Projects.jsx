...
function Projects() {
    const projects = [
        ...
        },
        {
            ...
            description: "A festive Christmas game built during a Hackathon challenge. This was a team project where we used React and collaborated through GitHub. I worked closely with my teammates to build a fun, interactive experience, focusing on component-based logic and managing a shared codebase under a tight deadline.",
